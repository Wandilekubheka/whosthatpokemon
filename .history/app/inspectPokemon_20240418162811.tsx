...
const InspectPokemon = () => {
  ...
  const svgUrl = 'https://raw.githubusercontent.com/PokeAPI/sprites/master/sprites/pokemon/other/dream-world/5.svg';
  if (isLoading) {
  ...
  return (
    ...
    <View>
      {/* Render the SVG */}
      <SvgUri width={200} height={200} source={{ uri: svgUrl }} />
    </View>
