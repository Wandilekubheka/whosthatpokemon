    ...
    <Modal animationType="slide" transparent={true} visible={isVisible}>
      <View className=" h-2/4 bottom-0 absolute w-full  bg-neutral-700 rounded-md">
        ...
        <View className=" items-center justify-evenly flex-1">
          {stats.map((stat) => (
            <View className=" flex-row justify-between  w-full px-10 bg-red-200 ">
              <Text className="text-white font-sInter text-md bg-black text-start">
                {stat.stat.name}
              </Text>
              <View className="">
                <Progress.Bar progress={stat.base_stat / 100} width={200} />
